...
```sql
SELECT order_id, order_date, user_id ,total_amount, AVG(total_amount) OVER(PARTITION BY user_id 
ORDER BY order_date DESC
ROWS BETWEEN 2 PRECEDING AND CURRENT ROW ) AS moving_avg FROM Orders ;
```
